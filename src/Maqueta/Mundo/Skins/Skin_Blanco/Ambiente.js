...
export default class Ambiente {
    ...
    crearCielo() {
        const niebla = new THREE.Fog(this.colores.coloresMundo.colorBruma, 9, 50)
    ...
    crearAmbientLight() {
        const ambientLight = new THREE.AmbientLight(this.colores.luces.ambient, 0.7)
    ...
    crearDirectionalLight() {
        const directionalLight = new THREE.DirectionalLight(this.colores.luces.directional, 0.45)
    ...
    crearEnvironmentMap() {
        ...
        /*this.environmentMapBg = {}
        this.environmentMapBg.intensity = 1
        this.environmentMapBg.texture = this.recursos.items.environmentMapTextureBg
        this.escena.background = this.environmentMapBg.texture*/
    }
