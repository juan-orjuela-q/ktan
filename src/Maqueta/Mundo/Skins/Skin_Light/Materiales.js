...
/*
        ...
        texturaNubes.repeat.x = 5
        texturaNubes.repeat.y = 5
        ...
        this.materialesProyecto.test = new THREE.MeshBasicMaterial({
            //map: texturaArboles,
            color: this.colores.coloresMundo.colorProyecto
        })

        //Satelital
        const texturaSatelital = this.recursos.items.textura_satelital
